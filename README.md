...
O `movie-booking-commons` precisa ser instalado no repositório Maven local (`mvn install`) antes de compilar os demais serviços, pois eles dependem dele via `groupId: org.javatechie`.
